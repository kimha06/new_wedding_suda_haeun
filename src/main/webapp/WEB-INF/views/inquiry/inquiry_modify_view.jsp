	...
	<div class="online_Awrite_form">
		<ul>
			<li class="box_li">
                ...
                <div class="value"><input type="text" name="btitle" id="btitle" class="online_write_input" value="${map.inqDto.btitle}" style="padding-left:5px;color:#000000;"></div>
            </li>                
            <li class="box_li">
...
<input type="hidden" name="bcontent" id="bcontent" value="${map.inqDto.bcontent}">
<script type="text/javascript">
	$(function(){
		var modify_data = $("#bcontent").val();
...
<div class="body">
<li class="box_li line2">
	<span class="online_write_title"><img src="../images/member_icon.png">&nbsp;&nbsp;&nbsp;이미지 확인</span>
	<c:choose>
		<c:when test="${map.inqDto.filename eq null}">
			<div class="value">
				<c:out value=""></c:out>
			</div>
		</c:when>
		<c:otherwise>
			<div class="value">
				<img src="/upload/${map.inqDto.filename}" width="200"><br>
			</div>
		</c:otherwise>
	</c:choose>
</li>
