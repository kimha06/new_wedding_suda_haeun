...
.jssora22r.jssora22rdn {
	background-position: -310px -31px
			...
			<p style="text-align: center;">
				<img class="txc-image" style="clear: none; float: none;" src="../upload/${map.stuDto.c_fileName }"></p>
		...
		<div class="online_Awrite_form">
			 <ul>
		        ...
		        <li class="box_li" style="padding-left: 40px; ">
		        	...
		        	<span style="position:absolute ; height: 200px; text-align: center;">${fn:replace(map.stuDto.content,br,cn)}</span>
		        	</div>
		        </li>
		         <li class="box_li" style="padding-left: 40px; ">
		            <span class="online_write_title"><img src="../images/member_icon.png">&nbsp;&nbsp;&nbsp;업체명 : </span>
		            <div class="online_write_title">
		            	<span style="text-align: center;">${map.stuDto.com_name}</span>
		            </div>
		         </li>
		          <li class="box_li" style="padding-left: 40px; ">
		            <span class="online_write_title"><img src="../images/member_icon.png">&nbsp;&nbsp;&nbsp;상품명 : </span>
		            <div class="online_write_title">
		            <span>${map.stuDto.c_productName}</span>   
		            </div>
		         </li> 
		         <li class="box_li" style="padding-left: 40px; ">
		            <span class="online_write_title"><img src="../images/member_icon.png">&nbsp;&nbsp;&nbsp;가격 : </span>
		            <div class="online_write_title">
		            	<span>${map.stuDto.c_productPrice}</span> 
		            </div>  
		         </li> 
            </ul>        
		</div>
			...
			<div class="pop_SStudio_wrap">
				<div class="pop_SStudio_leftbx">
					...
					<c:choose>
							...
							<c:otherwise>
								<a href="../hall/hall_reservation">
									<span class="btn_input"><input type="button" class="online_lg_color" id="regist_btn" value="상담신청" style="cursor: pointer; font-family: NanumBarunGothic;"></span>
								</a>
								<a href="./studio_list?page=${map.page }&search=${map.search}"><span class="btn_input"><input type="button" class="online_lg_color" id="regist_btn" value="목록" style="cursor: pointer; font-family: NanumBarunGothic;"></span></a>
							</c:otherwise>
						</c:choose>
