...
<div id="contain02">
	<div id="contain02_text">
		<span class="title_name">스튜디오 업체 상품 수정 페이지</span>
        <span class="title_detail">스튜디오 업체 상품 수정 페이지입니다.</span>
    </div>
</div>
...
<div id="online_write_wrap">    
   ...
   <input type="hidden" name="userid" id="userid" value="${map.stuDto.userid }">
   <input type="hidden" name="c_fileName" id="c_fileName" value="${map.stuDto.c_fileName }">
      ...
      <ul>
         <li class="box_li">
            ...
            <span class="online_write_title"><img src="../images/member_icon.png">&nbsp;&nbsp;&nbsp;업체 주소</span>
                <div class="value">
                <input type="input" name="c_address" id="c_address" class="online_write_input02" value="${map.stuDto.c_address }" style="padding-left:5px;color:#000000;">
                </div>
            </li>
            <li class="box_li">
...
<!-- DB에서 넘어온 데이터를 담는 용도 -->
<input type="hidden" name="DB_bcontent" id="DB_bcontent" value="${map.stuDto.content}">
