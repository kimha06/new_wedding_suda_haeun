...
<div class="mem_done_wrap">
    <div class="mem_done_t_wrap">
    	<span class="mem_done_tx1">모든 회원가입절차가&nbsp;<span class="mem_done_txcolor">완료</span>되었습니다.</span>
		<span class="mem_done_tx2">회원이 되신 것을 축하합니다.</span>
    </div>
    <div class="mem_done_ex_bx">
    	<span class="mem_done_ex_tx1">* 한번 부여된 아이디는 본인 소유의 고유아이디 이므로 바꾸실 수 없습니다.</span>
        <span class="mem_done_ex_tx2">* 홈페이지 이름 및 상담 등 모든 회원 활동시 필요한 아이디니 숙지하시기 바랍니다.</span>
        <span class="mem_done_ex_tx3">* 비밀번호는 회원정보수정에서 변경하실수 있습니다.</span>
    </div>
    <div class="mem_done_return_bx">
	<span class="mem_done_return"><a href="/member/login" style="color:#FFF;">로그인하기</a></span><br><br>
    </div>
</div>
