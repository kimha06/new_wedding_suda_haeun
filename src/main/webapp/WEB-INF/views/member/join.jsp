...
<div id="member_wrap">
	<form name="member_box" id="member_box" method="post">
	...
	<div class="member_form">
		<ul>
			...
			<li class="member_box_li_selet">
				...
				<div class="value_m">
					<input type="text" name="cusEnter" id="cusEnter" class="member_input_email hasDatepicker" readonly="" style="width:120px;cursor:pointer;padding-left:5px;font-size:15px;color:#000000;">
				</div>
			</li>
			<li class="member_box_li_selet">
			...
			<li class="member_box_li_selet">
				<span class="member_title_m" style="font-size:16px;"><img src="../images/member_icon03.png">&nbsp;&nbsp;&nbsp;유형</span>
