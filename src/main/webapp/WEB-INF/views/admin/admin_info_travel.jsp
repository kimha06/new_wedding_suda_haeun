						...
						<div class="gnb_oparea">
							...
							<ul>
								...
								<li data-menu="300400"><a
									...
									class="gnb_2da gnb_grp_style gnb_grp_div on">신혼여행 게시판</a></li>
								<li data-menu="300400"><a
						...
						<table>
							...
							<thead>
								<tr>
									...
									<th scope="col">가격 및 혜택</th>
									<th scope="col">대표이미지</th>
									<th scope="col">로고이미지</th>
							...
							<tbody>
								...
								<!-- 반복 시작 -->
								<c:forEach var="traDto" items="${map.t_list}">
								<tr class="bg0">
									...
									<td><input type="hidden" name="gr_id[0]" value="shop">travelCompanyInfo
									</td>
									<td><input type="hidden" name="board_table[0]" value="board"> 
										<a href="https://demo.sir.kr/gnuboard5/board">${traDto.infoId }</a></td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${traDto.userid }
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${traDto.com_name }
									</td>
									<td><input type="hidden" name="board_table[0]" value="board"> 
										<a href="https://demo.sir.kr/gnuboard5/board">${traDto.content }</a></td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${traDto.c_price }
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${traDto.c_image }
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${traDto.c_logo }
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${traDto.com_tel }
									</td>
