					...
					<div class="tbl_head01 tbl_wrap">
						<table>
							...
							<tbody>
								...
								<!-- 반복 시작 -->
								<c:forEach var="dreDto" items="${map.d_list}">
								<tr class="bg0">
								
									<td class="td_chk"><label for="chk_0" class="sound_only">자유게시판</label>
										<input type="checkbox" name="chk[]" value="0" id="chk_0">
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">dressCompanyInfo
									</td>
									<td><input type="hidden" name="board_table[0]" value="board"> 
										<a href="https://demo.sir.kr/gnuboard5/board">${dreDto.infoId }</a></td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${dreDto.userid }
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${dreDto.com_name }
									</td>
									<td><input type="hidden" name="board_table[0]" value="board"> 
										<a href="https://demo.sir.kr/gnuboard5/board">${dreDto.c_productName }</a></td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${dreDto.c_productPrice }
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${dreDto.c_onlineAddress }
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${dreDto.c_fileName }
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${dreDto.com_tel }
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${dreDto.c_officeHours }
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${dreDto.c_offDays }
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${dreDto.c_address }
									</td>
