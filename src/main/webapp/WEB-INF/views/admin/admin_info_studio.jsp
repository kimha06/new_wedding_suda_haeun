						...
						<div class="gnb_oparea">
							...
							<ul>
								<li data-menu="300100"><a
									...
									class="gnb_2da on ">스튜디오 게시판</a></li>
					...
					<div class="tbl_head01 tbl_wrap">
						<table>
							...
							<tbody>
								...
								<!-- 반복 시작 -->
								<c:forEach var="stuDto" items="${map.s_list}">
								<tr class="bg0">
								
									<td class="td_chk"><label for="chk_0" class="sound_only">자유게시판</label>
										<input type="checkbox" name="chk[]" value="0" id="chk_0">
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">studioCompanyInfo
									</td>
									<td><input type="hidden" name="board_table[0]" value="board"> 
										<a href="https://demo.sir.kr/gnuboard5/board">${stuDto.infoId }</a></td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${stuDto.userid }
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${stuDto.com_name }
									</td>
									<td><input type="hidden" name="board_table[0]" value="board"> 
										<a href="https://demo.sir.kr/gnuboard5/board">${stuDto.c_productName }</a></td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${stuDto.c_productPrice }
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${stuDto.c_onlineAddress }
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${stuDto.c_fileName }
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${stuDto.com_tel }
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${stuDto.c_officeHours }
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${stuDto.c_offDays }
									</td>
									<td><input type="hidden" name="gr_id[0]" value="shop">${stuDto.c_address }
									</td>
